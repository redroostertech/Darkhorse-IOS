...
class ShowPageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
  ...
  override func viewDidLoad() {
    ...
    mainTableView.register(EpisodeHeaderCell.nib,
                           forCellReuseIdentifier: EpisodeHeaderCell.identifier)
    mainTableView.register(PodcastEpisodeCell.nib,
                           forCellReuseIdentifier: PodcastEpisodeCell.identifier)
